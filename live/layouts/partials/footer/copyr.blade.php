<div class="container clearfix">
	...
	<div class="col_half col_last tright">
		...
		<i class="icon-envelope2"></i> info@graceframe.com <span class="middot">&middot;</span> <i class="icon-headphones"></i>  +1 (800) 264-0644 <span class="middot">&middot;</span> <i class="icon-skype2"></i> GraceOnSkype
	</div>
