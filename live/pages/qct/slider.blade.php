...
<div class="swiper-wrapper">
	<div itemprop="contentURL" class="swiper-slide dark" style="background-image: url('{!! url('live/images/product-overviews/qct/slider-ui.jpg') !!}');">
	...
	<div class="swiper-slide dark">
		...
		<div class="video-wrap">
			<video poster="{!! url('live/images/videos/qnique-overview-poster.jpg') !!}" preload="auto" loop autoplay muted>
				<source src="{!! url('live/images/videos/qnique-video-background.mp4') !!}" type='video/mp4' />
				<source src="{!! url('live/images/videos/qnique-video-background.webm') !!}" type='video/webm' />
			</video>
	 ...
	 <div class="swiper-slide dark">
		...
		<div class="video-wrap">
			<video poster="{!! url('live/images/product-overviews/qct/trace-poster.jpg') !!}" preload="auto" loop autoplay muted>
				<source src="{!! url('live/images/product-overviews/qct/trace-slider.mp4') !!}" type='video/mp4' />
				<source src="{!! url('live/images/product-overviews/qct/trace-slider.webm') !!}" type='video/webm' />
			</video>
			<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
		</div>
	</div>
	<div itemprop="contentURL" class="swiper-slide dark" style="background-image: url('{!! url('live/images/product-overviews/qct/short-v-long.jpg') !!}');">
		<div class="container clearfix">
			<div class="slider-caption slider-caption-center" itemprop="caption">
