...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/live/custom-css/qct.css') }}">
    ...
    <section id="content">
        ...
        <div class="content-wrap">
                ...
                <div class="row clearfix">
                    <div class="col-lg-7">
                        ...
                        <p class="center">
                            ...
                            <br>Download a free demo copy of the quilting software here!</p>
                    </div>
                    <div class="col-lg-5">
                        <img src="{!! url('live/images/product-overviews/qct/qnique-qct-push.jpg') !!}"
                             data-animate="fadeIn" alt="Quilter's Cretive Touch "></div>
                </div>
            </div>
            <!--promo/demo video ==================================-->
            ...
            <div class="section parallax dark nomargin"
                 style="background-image: url('{!! url('live/images/dark-background.jpg') !!}'); padding:0px"
                ...
                <div class="col-lg-7 topmargin" style="padding:0px;" data-animate="fadeInRight">
                    <div style="position: relative;">
                        <img src="{!! url('live/images/product-overviews/qct/touch-ui.png') !!}"
                             data-animate="fadeIn" alt="Touch Screen Freindly "></div>
                </div>
            </div>
            <!--flow-through-system =================================================-->
            ...
            <div class="section parallax nomargin "
                 style="background-image:url('{!! url('live/images/backgrounds/square_bg.png') !!}'); background-repeat:repeat;"
                 data-stellar-background-ratio="0.1">
                    ...
                    <div class="row topmargin-sm clearfix">
                        <div class="col_one_third nobottommargin">
                            <div class="feature-box   media-box fbox-bg items-container" data-animate="fadeInUp">
                                <div class="fbox-media">
                                    <a href="#" itemprop="url">
                                        <img itemprop="image"
                                             src="{!! url('live/images/product-overviews/qct/pick-pattern.jpg') !!}"
                                ...
                                <div class="matchheight fbox-desc">
                                    ...
                                    <p>
                                        Select a block, continuos line, corner, or more from the library of over 200
                                        included patterns.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col_one_third nobottommargin">
                            <div class="feature-box media-box fbox-bg items-container" data-animate="fadeInUp">
                                <div class="fbox-media">
                                    <a href="#" itemprop="url">
                                        <img itemprop="image"
                                             src="{!! url('live/images/product-overviews/qct/place.png') !!}"
                                             alt="using pantostacker in quilter's creative touch"/>
                                    </a>
                                </div>
                                <div class="matchheight fbox-desc">
                                    <h3>
                        ...
                        <div class="col_one_third col_last nobottommargin">
                            <div class="feature-box   media-box fbox-bg items-container" data-animate="fadeInUp">
                                <div class="fbox-media">
                                    <a href="#" itemprop="url">
                                        <img src="{!! url('live/images/product-overviews/qct/needle-stitch.jpg') !!}" alt="stitching"/>
                                    </a>
                                </div>
                                <div class="matchheight fbox-desc">
                                    <h3>
                ...
                <div class="container clearfix">
                    <div class="row topmargin-sm clearfix">
                        <div class="col-md-3" data-animate="fadeInUp">
                            <img src="{!! url('live/images/product-overviews/qct/panto-stacker.png') !!}" alt="Panto Stacker">
                        ...
                        <div class="col-md-3" data-animate="fadeInUp" data-delay="200">
                            <img src="{!! url('live/images/product-overviews/qct/patterncad.png') !!}" alt="Quilt Pattern Creation"/>
                        ...
                        <div class="col-md-3" data-animate="fadeInUp" data-delay="400">
                            <img src="{!! url('live/images/product-overviews/qct/trace.png') !!}" alt="Trace Image For Quilt Pattern" />
                        ...
                        <div class="col-md-3" data-animate="fadeInUp" data-delay="600">
                            <img src="{!! url('live/images/product-overviews/qct/record.jpg') !!}" alt="stitching" />
                        ...
                        <div class="col-md-12 center" data-animate="fadeIn">
                            <img src="{!! url('live/images/product-overviews/qct/qct-screen-shots.png') !!}" alt="Quilter's Creative Touch Screen Pictures" />
            ...
            <div class="section parallax nomargin"
                 style="background-image: url('{!! url('live/images/product-overviews/qct/quilt-bg.jpg') !!}'); border-top:2px solid #B14949; border-bottom:2px solid #B14949;"
                ...
                <div class="container center topmargin bottommargin">
                    ...
                    <img src="{!! url('live/images/product-overviews/qct/gold-logo.png') !!}" alt="Quilter's Creative Touch Gold Logo" />
            ...
            <div class="row notopmargin clearfix">
                <div class="col-md-4">
                    ...
                    <img src="{!! url('live/images/product-overviews/qct/qct-on-long.jpg') !!}"
                         alt="QCT on Longarm quilting machine"></div>
                <div class="col-md-4">
                    <div class="heading-block nobottomborder dark center nobottommargin" data-animate="fadeInUp">
                        <h4 style="padding:10px; background-color:#B14949;">Mid-arm Machines</h4>
                    </div>
                    <img src="{!! url('live/images/product-overviews/qct/qct-on-mid.jpg') !!}"
                ...
                <div class="col-md-4">
                    ...
                    <img src="{!! url('live/images/product-overviews/qct/qct-on-short.jpg') !!}"
            ...
            <div class="row clearfix common-height">
                <div class="col-md-6 center col-padding"
                     style="background: url('{!! url('live/images/product-overviews/qct/fold-bg.jpg') !!}') center center no-repeat; background-size: cover;">
                    <div>&nbsp;</div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="center bottommargin">
                            <a href="http://vimeo.com/101373765" data-lightbox="iframe" style="position: relative;">
                                <img src="{!! url('live/images/product-overviews/qct/tut-play.jpg') !!}"
                                     alt="Video"></a>
                        </div>
            ...
            <!--get QCT Now! ===================================-->
            <div class="section parallax nomargin"
                 style="background-image:url('{!! url('live/images/backgrounds/light_wool.png') !!}'); background-repeat:repeat; border-top:8px solid #B14949; border-bottom:8px solid #B14949;"
                 data-stellar-background-ratio="0.1">
