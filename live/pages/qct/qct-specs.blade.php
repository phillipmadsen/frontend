  ...
  <div class="content-wrap">
    ...
    <div class="container clearfix">
      <div class="heading-block center nobottomborder">
        <img src="{!! url('frontend/images/product-overviews/qct/machine.png') !!}" alt="quilting machine" />
      ...
      {{--<div class="col_full bottommargin-lg common-height">--}}
        ...
        {{--<div class="col-md-4 dark col-padding ohidden" style="height: 336px; background-color: rgb(26, 188, 156);">--}}
          {{--<div>--}}
        ...
        {{--<div class="col-md-4 dark col-padding ohidden" style="height: 336px; background-color: rgb(52, 73, 94);">--}}
          {{--<div>--}}
        ...
        {{--<div class="col-md-4 dark col-padding ohidden" style="height: 336px; background-color: rgb(231, 76, 60);">--}}
          {{--<div>--}}
    ...
    <div class="container clearfix">
      <div class="heading-block center nobottomborder">
        <img src="{!! url('frontend/images/product-overviews/qct/frame.png') !!}" alt="quilting frame" />
