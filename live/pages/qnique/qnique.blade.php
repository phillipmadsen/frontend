...
@section('header_styles')
	<!--page level css starts-->
		<link rel="stylesheet" type="text/css" href="{{ asset('/live/custom-css/qnique.css') }}">
...
@section('submenu')
@include('live.pages.qnique.partials.submenu')
@endsection
...
<section id="content">
	<div class="content-wrap">
			...
			<div class="row clearfix">
				...
				<div class="col-lg-7">
					<div style="position: relative;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
						<img src="{!! asset('/live/images/product-overviews/qnique/qnique-angled.png') !!}" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" alt="Qnique Quilting Machine">
					</div>
				</div>
			</div>
			<div class="row clearfix">
		...
		<div class="section parallax dark nobottommargin" style="background-image: url('{!! asset('live/images/dark-background.jpg') !!}');padding:0px 0px 0px 100px;" data-stellar-background-ratio="0.4">
			<div class="col_one_third nomargin">
				...
				<img data-animate="fadeInUp" src="{!! asset('/live/images/product-overviews/qnique/qnique-block.png') !!}" alt="Qnique larger quilting blocks">
			</div>
			<div class="col_two_third col_last nobottommargin">
				<img data-animate="fadeInRight" src="{!! asset('/live/images/product-overviews/qnique/qnique-side-frame.png') !!}" alt="Qnique extended throat space">
			</div>
		</div>
		<!--Superior Stitching Section ========================================-->
		<div class="section parallax nobottommargin dark" style="background-image: url('{!! asset('live/images/product-overviews/qnique/needle-blue.jpg') !!}');" data-stellar-background-ratio="0.4">
			<div class="col_half fright rightmargin">
				<div data-animate="fadeIn" class="transparent-block-dark col_half">
					<div class="block-img">
						<img src="{!! asset('/live/images/product-overviews/qnique/screen-square.jpg') !!}" alt="Qnique Quilter LCD Screen">
					</div>
		...
		<div class="section parallax nomargin dark" style="background-image: url('{!! asset('live/images/product-overviews/qnique/lights-frame.jpg') !!}');" data-stellar-background-ratio="0.4">
			<div class="col_half fright rightmargin">
				<div data-animate="fadeIn" class="transparent-block-dark col_half">
					...
					<div class="block-img">
						<img src="{!! asset('/live/images/product-overviews/qnique/lights-square.jpg') !!}" alt="Qnique Quilter LED Sewing Lights">
					</div>
				</div>
			</div>
		</div>
		<div class="section nomargin" style="background-color:white;">
			<div class="container clear-bottommargin clearfix">
				<div class="row topmargin-sm clearfix">
					<div class="col-md-6">
						<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
							<img src="{!! asset('/live/images/product-overviews/qnique/screen.jpg') !!}" alt="Qnique Display Screen">
					...
					<div class="col-md-6">
						<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
							<img src="{!! asset('/live/images/product-overviews/qnique/bobbin-winder.jpg') !!}" alt="qnique bobbin winder">
				...
				<div class="row topmargin-sm clearfix">
					<div class="col-md-6 ">
						<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
							<img src="{!! asset('/live/images/product-overviews/qnique/bobbin-replace.jpg') !!}" alt="replacing quilting machine bobbin">
					...
					<div class="col-md-6">
						<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
							<img src="{!! asset('/live/images/product-overviews/qnique/m-class-bobbin.jpg') !!}" alt="M-class bobbin">
					...
					<div class="row topmargin-sm clearfix">
						<div class="col-md-6">
							<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
								<img src="{!! asset('/live/images/product-overviews/qnique/buttons.jpg') !!}" alt="replacing quilting machine bobbin">
						...
						<div class="col-md-6">
							<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
								<img src="{!! asset('/live/images/product-overviews/qnique/accessory-ports.jpg') !!}" alt="qnique bobbin winder">
			...
			<div class="section nomargin">
				<div class="container clearfix">
					<div class="row topmargin-lg bottommargin-sm">
						...
						<img data-animate="fadeInRight" src="{!! asset('/live/images/product-overviews/qnique/qnique-frame-large.png') !!}" />
					</div>
					<div class="row topmargin-sm clearfix">
						<div class="col-md-6">
							<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
			...
			<div class="container clearfix">
				...
				<div class="row topmargin-sm clearfix">
					<div class="col_one_fourth rightmargin-sm">
						...
						<img src="{!! asset('/live/images/product-overviews/qnique/qnique-frame-700.png') !!}" alt="Qnique Quilting Frame Package" />
						<dl>
					...
					<div class="col_one_fourth rightmargin-sm">
						...
						<img src="{!! asset('/live/images/product-overviews/qnique/gracie-king-combo.png') !!}" alt="Qnique Quilting Frame Package" />
						<dl>
							<dt>Sets up in sizes:</dt>
					...
					<div class="col_one_fourth rightmargin-sm">
						...
						<img src="{!! asset('/live/images/product-overviews/qnique/gracie-queen-combo.png') !!}" alt="Qnique Quilting Frame Package" />
						<dl>
							<dt>Sets up in sizes:</dt>
							<dl>Queen, Crib</dl>
							<dt>Maximum Length:</dt>
					...
					<div class="col_one_fourth rightmargin-sm">
						...
						<img src="{!! asset('/live/images/product-overviews/qnique/SR2-frame-rockit-combo.png') !!}" alt="Qnique Quilting Frame Package" />
						<dl>
							<dt>Sets up in sizes:</dt>
							<dl>Queen, Crib</dl>
							<dt>Maximum Length:</dt>
