...
@section('scripts')
    ...
    <link rel="stylesheet" type="text/css" href="{!! url('frontend/include/rs-plugin/css/settings.css') !!}" media="screen" />
    <!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
    <script type="text/javascript" src="{!! url('frontend/include/rs-plugin/js/jquery.themepunch.tools.min.js') !!}"></script>
    <script type="text/javascript" src="{!! url('frontend/include/rs-plugin/js/jquery.themepunch.revolution.min.js') !!}"></script>
<script>
                ...
                <div class="container clearfix ">
                    <nav class="one-page-menu">
                        <ul>
                            ...
                            <li><a class="current" href="{!! url('/') !!}/qnique/features/"><div>Features</div></a></li>
                            <li><a href="{!! url('/') !!}/qnique/specs/"><div>Specs</div></a></li>
                            <li><a href="{!! url('/') !!}/qnique/accessories/"><div>Accessories</div></a></li>
...
@section('content')
<style>
#xray-wrapper{position:relative;/*    min-height: 800px;
        min-width: 1200px; max-height: 800px; max-width: 1200px;*/width:100%;height:100%;max-width:1200px;max-height:800px;}
...
jQuery(window).load(function(){
    ...
    $container.isotope('layout');
     ...
     (function($) {
        ...
        $('#outside').fadeDelay(100);
   });
//     $(window).scroll(function(i){
//     var scrollVar = $(window).scrollTop();
//     $('#outside').css({'top': .7*scrollVar });
//     $('#outside').css({'opacity':( 100-scrollVar )/100});
//     })
...
$('[id^="icon-0"]').click(function () {
var $image0 = $('[id^="prC0"]');
$('[id^="prC"]').not($image0).hide();
...
$('[id^="icon-1"]').click(function () {
var $image1 = $('[id^="prC1"]');
$('[id^="prC"]').not($image1).hide();
...
$('[id^="icon-2"]').click(function () {
var $image2 = $('[id^="prC2"]');
$('[id^="prC"]').not($image2).hide();
...
$('[id^="icon-3"]').click(function () {
var $image3 = $('[id^="prC3"]');
$('[id^="prC"]').not($image3).hide();
...
$('[id^="icon-4"]').click(function () {
var $image4 = $('[id^="prC4"]');
$('[id^="prC"]').not($image4).hide();
...
$('[id^="icon-5"]').click(function () {
var $image5 = $('[id^="prC5"]');
$('[id^="prC"]').not($image5).hide();
...
$('[id^="icon-6"]').click(function () {
var $image6 = $('[id^="prC6"]');
$('[id^="prC"]').not($image6).hide();
...
$('[id^="icon-7"]').click(function () {
var $image7 = $('[id^="prC7"]');
$('[id^="prC"]').not($image7).hide();
